...
..
   ...
   *Map properties:*
   ...
   ..
      ...
      Content of part to attach, either inline or by referencing the
      ID of another software config resource
...
..
   ...
   *Map properties:*
   ...
   ..
      ...
      A character class and its corresponding min constraint to
      ...
      Allowed values: lettersdigits, letters, lowercase, uppercase,
   ...
   ..
      ...
      The minimum number of characters from this character class that
      will be in the generated string.
...
..
   ...
   *Map properties:*
   ...
   ..
      ...
      The minimum number of characters from this sequence that will be
   ...
   ..
      ...
      A character sequence and its corresponding min constraint to
      generate the random string from.
...
..
   ...
   *
   ...
   Policy to be processed when doing an update which requires removal
   ...
   *Map properties:*
   ...
   ..
      ...
      List of resources to be removed when doing an update which
      requires removal of specific resources. The resource may be
      specified several ways: (1) The resource name, as in the nested
      stack, (2) The resource reference returned from get_resource in
      a template, as available via the 'refs' attribute Note this is
      destructive on update when specified; even if the count is not
      being reduced, and once a resource name is removed, it's name is
      never reused in subsequent updates
...
..
   ...
   The minimum number of resources in service while rolling updates
   are being executed.
...
..
   ...
   *Map properties:*
   ...
   ..
      ...
      Denotes that the deployment is in an error state if this output
      has a value.
...
..
   ...
   *Map properties:*
   ...
   ..
      ...
      compute instance, an ingress security group rule matches traffic
      that is incoming (ingress) for that instance. An egress rule is
      applied to traffic leaving the instance.
   ...
   ..
      ...
      port_range_max attribute. If the protocol is ICMP, this value
   ...
   ..
      ...
      attribute. If the protocol is ICMP, this value must be an ICMP
      type.
   ...
   ..
      ...
      values include tcp, udp, and icmp.
...
..
   ...
   *Map properties:*
   ...
   ..
      ...
      Specifies database names for creating databases on instance
      creation.
...
..
   ...
   *Map properties:*
   ...
   ..
      ...
      Name or UUID of the network to attach this NIC to. Either port
      or network must be specified.
   ...
   ..
      ...
      Name or UUID of Neutron port to attach this NIC to. Either port
      or network must be specified.
...
..
   ...
   *Map properties:*
   ...
   ..
      ...
      Names of databases that those users can access on instance
      creation.
   ...
   ..
      ...
      The host from which a user is allowed to connect to the
      database.
...
Cloud. These resources either allow using Rackspace services that
don't have equivalent services in OpenStack or account for differences
between a generic OpenStack deployment and the Rackspace Cloud.

Rackspace resources depend on the dev branch of pyrax to work
...
This plugin enables the use of  Docker containers in a Heat template
and requires the docker-py package. You can find more information in
the DOCKER_README.
...
..
   ...
   *
   ...
   Allowed values: SETPCAP, SYS_MODULE, SYS_RAWIO, SYS_PACCT,
   SYS_ADMIN, SYS_NICE, SYS_RESOURCE, SYS_TIME, SYS_TTY_CONFIG, MKNOD,
   AUDIT_WRITE, AUDIT_CONTROL, MAC_OVERRIDE, MAC_ADMIN, NET_ADMIN,
   SYSLOG, CHOWN, NET_RAW, DAC_OVERRIDE, FOWNER, DAC_READ_SEARCH,
   FSETID, KILL, SETGID, SETUID, LINUX_IMMUTABLE, NET_BIND_SERVICE,
   NET_BROADCAST, IPC_LOCK, IPC_OWNER, SYS_CHROOT, SYS_PTRACE,
   SYS_BOOT, LEASE, SETFCAP, WAKE_ALARM, BLOCK_SUSPEND, ALL
...
..
   ...
   *Map properties:*
   ...
   ..
      ...
      The permissions of the container to read/write/create the
      devices.
