   ...
   ..
      ...
      *Map properties:*
      ...
      ..
         ...
         Indicate whether the volume should be deleted when the
      ...
      ..
         ...
         The size of the volume, in GB. Must be equal or greater than
         the size of the snapshot. It is safe to leave this blank and
...
..
   ...
   The number of consecutive health probe failures required before
