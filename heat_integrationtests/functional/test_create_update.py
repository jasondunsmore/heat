...
'''
        ...
        expected_exc_msg = '"str_replace" params must be strings or numbers'
        stack = self.client.stacks.get(stack_identifier)
        self.assertIn(expected_exc_msg, stack.stack_status_reason)

        self.update_stack(stack_identifier, template=valid_template,
                          expected_status='UPDATE_COMPLETE')

        self.update_stack(stack_identifier, template=invalid_template,
                          expected_status='UPDATE_FAILED')
        stack = self.client.stacks.get(stack_identifier)
        self.assertIn(expected_exc_msg, stack.stack_status_reason)
