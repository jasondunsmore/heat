...
engine_opts = [
    ...
    cfg.StrOpt('distributed_lock_driver',
               default='database',
               help='Driver to use for multi-engine distributed lock'),
    cfg.StrOpt('zk_lock_acquire_timeout',
               default=2,
    ...
    cfg.StrOpt('engine_id',
               ...
               help='Engine id to use for stack locks'),
