...
try:
    ...
    logger.error("impacket not available. this module will not work.")
else:
    ...
    class PsexecWrapper(object):
        def __init__(self, username, password, address, path="C:\\Windows"):
        ...
        def run_cmd(self, cmd_lines):
            ...
            self._psexec.stdin.write(cmd_lines)
            self._psexec.stdin.flush()
    ...
    class PSEXEC:
        ...
        def doStuff(self, rpctransport):
            ...
            try:
                ...
                packet['Machine'] = ''.join([random.choice(
                    string.letters) for i in range(4)])
                ...
                try:
                    ...
                    try:
                            ...
                            if ans != LastDataSent:  # NOQA
                                ...
                                LastDataSent = ''
                            # Just in case this got out of sync, i'm cleaning
                            # it up if there are more than 10 chars,
                            # it will give false positives tho.. we should find
