...
class LoadBalancerTest(common.HeatTestCase):
    ...
    def test_update_delete_node_failed(self):
        ...
        self.m.ReplayAll()
        self.assertRaises(ValueError, rsrc.check_update_complete, deleted_node)
        self.m.VerifyAll()
    ...
    def test_update_nodes_immutable(self):
        ...
        new_nodes = [fake_lb.Node(address=expected_ip, port=80,
                                  condition='ENABLED')]
        self.m.StubOutWithMock(fake_lb, 'add_nodes')
        fake_lb.add_nodes(new_nodes).AndReturn(None)
